...
export default function LocationView(props) {
  ...
  return <Map setEditState={props.setEditState} editState={props.editState} />;
}

function Map(props) {
  const [selected, setSelected] = useState({
    lat: props.editState.lat,
    lng: props.editState.lng,
  });
  let onMarkerDragEnd = (lat, lng) => {
    setSelected({ lat, lng });
  };
  useEffect(() => {
    props.setEditState({
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              value={props.editState["Tipo de vía"]}
              onChange={(e) =>
                props.setEditState({
                  ...props.editState,
                  ["Tipo de vía"]:
            ...
            >
              ...
              <option selected={props.editState["Tipo de vía"] === "Calle"}>
                Calle
              </option>
              <option selected={props.editState["Tipo de vía"] === "Jiron"}>
                Jiron
              </option>
              <option selected={props.editState["Tipo de vía"] === "Avenida"}>
                Avenida
              </option>
              <option selected={props.editState["Tipo de vía"] === "Pasaje"}>
                Pasaje
              </option>
              <option selected={props.editState["Tipo de vía"] === "Carretera"}>
                Carretera
              </option>
              <option selected={props.editState["Tipo de vía"] === "Manzana"}>
                Manzana
              </option>
              <option selected={props.editState["Tipo de vía"] === "Lote"}>
                Lote
              </option>
              <option selected={props.editState["Tipo de vía"] === "Parcela"}>
                Parcela
              </option>
              <option selected={props.editState["Tipo de vía"] === "Fundo"}>
                Fundo
              </option>
              <option selected={props.editState["Tipo de vía"] === "Sin vía"}>
                Sin vía
              </option>
            </select>
          </div>
          <div>
            ...
            <input
              ...
              type="text"
              className="mt-1 block w-full rounded-md border border-gray-300 py-1.5 px-3 shadow-sm focus:border-custom-500 focus:outline-none focus:ring-custom-500 sm:text-sm"
              value={props.editState[" Nro de frentes"]}
              onChange={(e) =>
                props.setEditState({
                  ...props.editState,
                  [" Nro de frentes"]: e.target.value,
                })
              }
            />
          </div>
...
const PlacesAutocomplete = (props) => {
  ...
  const [departamento, setDepartamento] = useState(
    props.editState.departamento
  );
  const [provinciaDB, setProvinciaDB] = useState(
    provincias[departamento.id_ubigeo]
  );
  const [provincia, setProvincia] = useState(props.editState.provincia);

  const [distritoDB, setDistritoDB] = useState(distritos[provincia.id_ubigeo]);
  const [distrito, setDistrito] = useState(props.editState.distrito);
  useEffect(() => {
    setProvinciaDB(provincias[departamento.id_ubigeo]);
    setProvincia(provincias[departamento.id_ubigeo][0]);
  }, [departamento]);

  useEffect(() => {
    setDistritoDB(distritos[provincia.id_ubigeo]);
    setDistrito(distritos[provincia.id_ubigeo][0]);
  }, [provincia]);
      ...
      <div className="py-6 px-4 sm:p-6">
        ...
        <div className="mt-5 grid grid-cols-3 gap-4">
          <div>
            ...
            >
              ...
              {departamentos.map((item, i) => (
                <option key={i} value={JSON.stringify(item)}  selected={
                    item.nombre_ubigeo ==
                    props.editState.departamento.nombre_ubigeo
                  }>
                  {item.nombre_ubigeo}
                </option>
              ))}
          ...
          <div>
            ...
            >
              <option disabled selected></option>
              {provinciaDB.map((item, i) => (
                <option key={i} value={JSON.stringify(item)}  selected={
                    item.nombre_ubigeo ==
                    props.editState.provincia.nombre_ubigeo
                  }>
                  {item.nombre_ubigeo}
                </option>
              ))}
          ...
          <div>
            ...
            >
              <option disabled selected></option>
              {distritoDB.map((item, i) => (
                <option key={i} value={JSON.stringify(item)}  selected={
                    item.nombre_ubigeo ==
                    props.editState.distrito.nombre_ubigeo
                  }>
                  {item.nombre_ubigeo}
                </option>
              ))}
      ...
      <div className="py-6 px-4 sm:p-6">
        <div>
          ...
          <Combobox onSelect={handleSelect}>
            <ComboboxInput
              value={props.editState.direccion}
